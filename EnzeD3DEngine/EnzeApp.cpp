...
void EnzeApp::CreateSwapChainAndQueue()
{
...
void EnzeApp::LoadAssets()
{
    // Create a root signature for one constant.
    BuildRootSignature();
...
void EnzeApp::CreateCommandList()
{
